...
const LeaderboardCard = React.forwardRef<HTMLDivElement, LeaderboardCardProps>(
  (
    ...
    return (
      <div
        ref={ref}
        // Adapted to this dashboard's existing card convention (see
        // TopDonorsCard.tsx) rather than shadcn's bg-card/border tokens —
        // this project has no shadcn CSS theme variables defined, so those
        // classes would render with no color at all.
